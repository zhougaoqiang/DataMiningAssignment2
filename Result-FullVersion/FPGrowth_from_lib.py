...
def FPGrowth(filename, support, confidence=0):
    import time
    startTime = time.time()
    ...
    importantInfo = [filename, 'FPGrowth', support, len(trans), totalItem, execTime]
    return frequentTrans, ar, importantInfo

if __name__ == '__main__':
    FPGrowth('Market_Basket-number-TOP20.csv', 0.005,0.5)